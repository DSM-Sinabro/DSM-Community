...
exports.getPostList = (req, res) => {
    ...
    recruit_study.findAll() // 모든 글 조회 (작성 날짜순)
...
exports.createPost = (req, res) => {
    ...
    recruit_study.create(title, major, startPeriod, endPeriod, users, option, content, writer) // 글 생성
...
exports.dropPost = (req, res) => {
    ...
    recruit_study.findOneAndRemove({
            "writer": user,
            "_id": pid
...
exports.readPost = (req, res) => {
    ...
    recruit_study.findById(pid).populate('writer',['name','cardinal','code']).exec()
    .then(respond)
    .catch(onError);
}